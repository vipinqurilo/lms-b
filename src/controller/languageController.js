...
exports.getLanguages = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to retrieve languages", details: error.message });
  }
};
...
exports.getLanguageById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to retrieve language", details: error.message });
  }
};
...
exports.deleteLanguage = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to delete language", details: error.message });
  }
};
